...
import { Banknote, Calendar, CreditCard, Landmark, Mail, MapPin, Phone, User, Globe } from 'lucide-react';
...
const redeemers: Redeemer[] = [
  {
    ...
    location: { state: 'Kano', lga: 'Kano Municipal', ipAddress: '197.210.70.11', redemptionDate: '2024-03-20T10:05:15Z' },
  },
  {
    id: 'RED-002',
    ...
    location: { state: 'Lagos', lga: 'Ikeja', ipAddress: '102.89.43.1', redemptionDate: '2024-03-21T11:30:00Z' },
  },
  {
    id: 'RED-003',
    ...
    location: { state: 'Abuja (FCT)', lga: 'Abuja Municipal', ipAddress: '41.190.2.10', redemptionDate: '2024-03-22T09:15:45Z' },
  },
  {
    id: 'RED-004',
    ...
    location: { state: 'Oyo', lga: 'Ibadan North', ipAddress: '196.46.244.10', redemptionDate: '2024-03-23T15:00:22Z' },
  },
  {
    id: 'RED-005',
    ...
    location: { state: 'Rivers', lga: 'Port Harcourt', ipAddress: '154.113.1.5', redemptionDate: '2024-03-24T18:45:10Z' },
  }
];
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <div>
            <h3 className="text-lg font-semibold mb-4 flex items-center"><MapPin className="mr-2 h-5 w-5" /> Location & Time</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <InfoRow icon={Globe} label="IP Address" value={redeemer.location.ipAddress} />
                <InfoRow icon={Calendar} label="Redemption Time" value={formattedRedemptionDate} />
            </div>
        </div>
      </CardContent>
    </Card>
